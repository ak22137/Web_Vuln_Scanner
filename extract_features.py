...
#         Adjust this list to match the exact features required by the model.
#         """
#         features_list = [
#             'URL Length',
#             'Domain Length',
...
#             'Contains Email',
#             'Redirect Count',
#             'Top-Level Domain Count'  # Ensure this matches the model's expected features
#         ]
...
#         Adjust the extracted features to match the training dataset of the classifier.
#         """
...
#         # Reorder features to match the training dataset
#         reordered_dict = {k: new_dataset.get(k, -1) for k in features_list}  # Default to -1 for missing features
